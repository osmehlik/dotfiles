...
COLOR_DARK_DELIM="${COLOR_DARK}${COLOR_DELIM}"
COLOR_LIGHT_DELIM="${COLOR_LIGHT}${COLOR_DELIM}"
...
COLOR1="${COLOR_START}${COLOR_LIGHT_PURPLE}"
COLOR2="${COLOR_START}${COLOR_LIGHT_RED}"

PS1="${COLOR1}<${COLOR2}\u@\h${COLOR1}>\n\w$ ${COLOR_STOP}"
PS2="${COLOR1}> ${COLOR_STOP}"
